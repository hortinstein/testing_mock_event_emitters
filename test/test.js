...
startTests = function() {
    before(function() {
        ...
        pcap = require('pcap');
        pcap_emitter = require('../module.js')("test");//replace the module `request` with a stub object        
    });
    it('should correctly mock pcap functions for testing', function(done) {
        pcap.test().should.equal('inject works!');
        done(); 
    });
    it('should correctly alter a function for testing', function(done) {
        pcap.test = function(){
            return 'inject works...altered!';
        }
        pcap.test().should.equal('inject works...altered!');
        done(); 
    });
